...
const ProgramHero: React.FC<ProgramHeroProps> = ({ searchTerm, onSearchChange }) => {
  ...
  return (
    <section className="relative bg-gradient-to-r from-blue-900 via-indigo-800 to-blue-900 text-white overflow-hidden">
      {/* Background elements */}
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className={`md:w-1/2 text-center md:text-left transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              ...
              <h1 className="text-4xl sm:text-5xl font-extrabold mb-6 leading-tight">
                Academic <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-indigo-300">Programs</span>
              </h1>
              <p className="text-xl text-indigo-100 mb-8 leading-relaxed">
                Discover innovative academic programs designed to foster entrepreneurship and innovation at Far Western University.
              </p>
              ...
              <div className="relative h-64 md:h-80 w-full">
                ...
                <div className="relative h-full w-full rounded-2xl overflow-hidden shadow-2xl border border-white/10">
                  <Image
                    ...
                    alt="FWU Academic Programs"
                    fill
                    className="object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-blue-900/80 to-transparent"></div>
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <span className="bg-blue-600/80 text-white text-xs font-bold px-3 py-1 rounded-full backdrop-blur-sm">
