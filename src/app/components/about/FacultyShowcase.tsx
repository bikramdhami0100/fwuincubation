...
import { FaFlask, FaGlobe, FaChalkboardTeacher, FaBalanceScale, FaCode, FaLeaf, FaHeartbeat, FaTree, FaUsers } from 'react-icons/fa';
import { FiArrowRight } from 'react-icons/fi';
    ...
    <section ref={sectionRef} className="py-16 md:py-24 bg-gradient-to-b from-white to-indigo-50/50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {faculties.map((faculty, index) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                >
                  Learn More <FiArrowRight className="ml-1 group-hover/btn:translate-x-1 transition-transform duration-300" />
                </Link>
              </div>
        ...
        <div className={`text-center mt-12 transition-all duration-700 delay-700 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          >
            Explore All Faculties <FiArrowRight className="ml-2" />
          </Link>
        </div>
      </div>
    </section>
