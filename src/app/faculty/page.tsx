...
import { FiArrowRight, FiBook, FiUsers, FiAward, FiMapPin } from 'react-icons/fi';
import { FaGraduationCap, FaChalkboardTeacher, FaFlask, FaCode, FaBalanceScale, FaLeaf, FaHeartbeat, FaTree, FaGlobe } from 'react-icons/fa';
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mt-8">
                      <div className={`p-6 rounded-lg bg-${selectedFaculty.color}-50 border border-${selectedFaculty.color}-100`}>
                        <div className={`w-12 h-12 rounded-full bg-${selectedFaculty.color}-100 flex items-center justify-center mb-4`}>
                          <FaGraduationCap className={`text-${selectedFaculty.color}-600 text-xl`} />
                        </div>
                      ...
                      <div className={`p-6 rounded-lg bg-${selectedFaculty.color}-50 border border-${selectedFaculty.color}-100`}>
                        <div className={`w-12 h-12 rounded-full bg-${selectedFaculty.color}-100 flex items-center justify-center mb-4`}>
                          <FiBook className={`text-${selectedFaculty.color}-600 text-xl`} />
                        </div>
                      ...
                      <div className={`p-6 rounded-lg bg-${selectedFaculty.color}-50 border border-${selectedFaculty.color}-100`}>
                        <div className={`w-12 h-12 rounded-full bg-${selectedFaculty.color}-100 flex items-center justify-center mb-4`}>
                          <FiUsers className={`text-${selectedFaculty.color}-600 text-xl`} />
                        </div>
